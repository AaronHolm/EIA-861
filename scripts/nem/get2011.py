...
def get2011():
	...
	cap = pd.read_excel(io.BytesIO(data), sheet_name='Month_State', usecols='A:C,I:L')
	...
	esb = pd.read_excel(io.BytesIO(data), sheet_name='Month_State', usecols='A:C,D:G')
	...
	count = pd.read_excel(io.BytesIO(data), sheet_name='Month_State', usecols='A:C,N:Q')
